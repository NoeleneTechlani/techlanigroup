      ...
      <section className="mx-auto max-w-4xl">
        ...
        <div className="mb-10 grid gap-4 md:grid-cols-3">
          {[
            ...
            <div key={item} className="rounded-2xl border border-zinc-800 bg-zinc-950 p-6">
        ...
        <p className="mt-10 text-sm text-zinc-500">
          This is an independent concept demonstration created by Techlani Digital.
          It is not affiliated with or endorsed by Self Storage Paraparaumu.
        </p>
      </section>
    </main>
  )
